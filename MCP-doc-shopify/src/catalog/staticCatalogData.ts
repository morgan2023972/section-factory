import type { CategorySettingsMap, ShopifySchemaGuide } from "./types.js";

export const SHOPIFY_SECTION_RULES: readonly string[] = [
...
export const SHOPIFY_SCHEMA_GUIDE: ShopifySchemaGuide = {
  attributes: [
    "name",
    "tag",
    "class",
...
export const CATEGORY_SETTINGS_MAP: CategorySettingsMap = {
  hero: [
    "heading",
    "subheading",
    "button_label",
